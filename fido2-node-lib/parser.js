...
async function parseAttestationObject(attestationObject) {
	...
	//let f2libMain = require("./main.js")
	//let Fido2Lib = new f2libMain
	if (!Fido2Lib){
		Fido2Lib = require("./main.js")
	}
...
module.exports.parseAttestationObject = parseAttestationObject;
module.exports.parseAuthenticatorData = parseAuthenticatorData;
module.exports.parseAuthnrAssertionResponse = parseAuthnrAssertionResponse;
module.exports.parseAuthnrAttestationResponse = parseAuthnrAttestationResponse;
module.exports.parseClientResponse = parseClientResponse;
module.exports.parseExpectations = parseExpectations;
