...
class PublicKey {
	...
	constructor() {
		...
		isPem = theUtils.isPem
		pemToBase64 = theUtils.pemToBase64
		abToPem = theUtils.abToPem
		tools = theUtils.tools
	}
	...
	async fromPem(pem, hashName) {
		...
		const asn1 = require('asn1js').fromBER(ber)
		if (asn1.offset === -1) {
...
module.exports.coseAlgToStr = coseAlgToStr;
module.exports.coseAlgToHashStr = coseAlgToHashStr;