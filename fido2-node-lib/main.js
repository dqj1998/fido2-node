...
*/
//const utils = require("./utils.js")
module.exports.arrayBufferEquals = utils.arrayBufferEquals;
module.exports.abToBuf = abToBuf;
module.exports.abToHex = utils.abToHex;
module.exports.appendBuffer = appendBuffer;
module.exports.coerceToArrayBuffer = coerceToArrayBuffer;
module.exports.coerceToBase64 = utils.coerceToBase64;
module.exports.coerceToBase64Url = utils.coerceToBase64Url;
module.exports.isBase64Url = utils.isBase64Url;
module.exports.isPem = utils.isPem;
module.exports.jsObjectToB64 = utils.jsObjectToB64;
module.exports.pemToBase64 = utils.pemToBase64;
module.exports.str2ab = utils.str2ab;
...
module.exports.parseAttestationObject = parser.parseAttestationObject;
module.exports.parseAuthenticatorData = parser.parseAuthenticatorData;
module.exports.parseAuthnrAssertionResponse = parser.parseAuthnrAssertionResponse;
module.exports.parseAuthnrAttestationResponse = parser.parseAuthnrAttestationResponse;
module.exports.parseClientResponse = parser.parseClientResponse;
module.exports.parseExpectations = parser.parseExpectations;

//export { Certificate, CertManager, CRL, helpers } from "./certUtils.js";
const certUtils = require("./certUtils.js")
//require("./certUtils.js")
module.exports.Certificate = certUtils.Certificate;
module.exports.CertManager = certUtils.CertManager;
module.exports.CRL = certUtils.CRL;
module.exports.helpers = certUtils.helpers;

//export { PublicKey, coseAlgToHashStr, coseAlgToStr } from "./keyUtils.js";
const keyUtils = require("./keyUtils.js")
module.exports.PublicKey = keyUtils.PublicKey;
module.exports.coseAlgToHashStr = keyUtils.coseAlgToHashStr;
module.exports.coseAlgToStr = keyUtils.coseAlgToStr;

// Export response
//export { Fido2AssertionResult, Fido2AttestationResult, Fido2Result };
module.exports.Fido2AssertionResult = Fido2AssertionResult;
module.exports.Fido2AttestationResult = Fido2AttestationResult;
module.exports.Fido2Result = Fido2Result;
...
module.exports.androidSafetyNetAttestation = androidSafetyNetAttestation;
module.exports.fidoU2fAttestation = fidoU2fAttestation;
module.exports.noneAttestation = noneAttestation;
module.exports.packedAttestation = packedAttestation;
module.exports.tpmAttestation = tpmAttestation;
module.exports.appleAttestation = appleAttestation;